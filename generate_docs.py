...
sys.path.insert(0, '.')
from build_pptx import _build_manual_pptx, _build_report_pptx, _build_setup_guide_pptx
...
with open('dist_docs/setup_guide.pptx', 'wb') as f:
    f.write(_build_setup_guide_pptx().read())
print('setup_guide.pptx OK')
